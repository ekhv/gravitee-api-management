...
public class DeleteEnvironmentCommandHandlerTest {
    ...
    public void setUp() throws Exception {
        ...
        when(pageRepository.deleteByReferenceIdAndReferenceType(ENV_ID, PageReferenceType.ENVIRONMENT)).thenReturn(List.of(ENV_ID));
        when(pageRepository.deleteByReferenceIdAndReferenceType(API_ID_1, PageReferenceType.API)).thenReturn(List.of(API_ID_1));
        when(pageRepository.deleteByReferenceIdAndReferenceType(API_ID_2, PageReferenceType.API)).thenReturn(List.of(API_ID_2));
    ...
    public void should_delete_environment() throws TechnicalException {
        ...
        verify(integrationJobRepository).deleteByEnvironmentId(ENV_ID);
