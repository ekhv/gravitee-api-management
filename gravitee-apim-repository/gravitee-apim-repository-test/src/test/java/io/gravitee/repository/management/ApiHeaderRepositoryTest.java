...
public class ApiHeaderRepositoryTest extends AbstractManagementRepositoryTest {
    ...
    public void should_delete_by_environment_id() throws Exception {
        final var nbBeforeDeletion = apiHeaderRepository.findAllByEnvironment("ToBeDeleted").size();

        final var deleted = apiHeaderRepository.deleteByEnvironmentId("ToBeDeleted");
        final var nbAfterDeletion = apiHeaderRepository.findAllByEnvironment("ToBeDeleted").size();
